...
<html lang="pt">
    ...
    <body>
        ...
        <a class="hidden" href="index.php" id="back-link">
            <svg viewBox="0 0 27 22" version="1.1" xmlns="http://www.w3.org/2000/svg" style="stroke:#969696;fill-rule:evenodd;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:1.5;">
                <g>
            ...
            </svg>Voltar para a lista de Amiibo
        </a>
        <main class="hidden">
            ...
            <div id="info">
                <div id="releases">
                    <h4>Lançamentos globais</h4>
                    <p></p>
                </div>
                <div id="games">
                    <h4>Jogos compatíveis</h4>
                </div>
            </div>
        </main>
        <?php
